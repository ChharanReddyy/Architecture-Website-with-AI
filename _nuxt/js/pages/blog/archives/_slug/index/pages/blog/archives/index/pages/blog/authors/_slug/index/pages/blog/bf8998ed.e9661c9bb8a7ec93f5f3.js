...
(window.webpackJsonp = window.webpackJsonp || []).push([
    [0], {
        ...
        568: function(t, e, r) {
            ...
            var x = function() {
                    return r.e(59).then(r.bind(null, 606))
                },
                I = l.componentFactory.mixin(y.F).create({
                    ...
                    computed: {
                        filter: function() {
                            var filter = new f.a({
                                queryParameters: new O.Ab(P(P(P(P({
                                    siteId: this.siteId,
                                    includeOnlyPublished: !0,
                                    includeAuthor: !0,
                                    includeMainCategoryDetails: !0
                                }, this.authorId && new O.Ab({
                                    authorId: this.authorId
                                })), this.archiveDate && new O.Ab({
                                    archiveDate: this.archiveDate
                                })), this.isSubTemplate && new O.Ab({
                    ...
                    methods: {
                            ...
                            return Object(n.a)(regeneratorRuntime.mark((function r() {
                                ...
                                return regeneratorRuntime.wrap((function(r) {
                                    for (;;) switch (r.prev = r.next) {
                                        case 0:
                                            return r.prev = 0, e.isLoading = !0, o = filter || e.filter, n = o.include, l = o.orderBy, d = o.take, c = o.skip, m = new O.Ab(P(P({}, e.filter.queryParameters), {}, {
                                                include: n,
                                                orderBy: l,
                                                take: d,
                                                skip: c
                                            })), r.next = 6, e.$api.get(new O.Ab(m));
                                        case 6:
                                ...
                                return regeneratorRuntime.wrap((function(e) {
                                    for (;;) switch (e.prev = e.next) {
                                        case 0:
                                            ...
                                            return r = t.page.sliderPostIds, t.isLoading = !0, e.next = 6, t.$api.get(new O.Ab({
                                                siteId: t.siteId,
                                                ids: r,
                                                includeOnlyPublished: !0,
                                                includeAuthor: !0,
                        ...
                        renderPostListSlider: function(t) {
                            ...
                            })]) : Object(v.M)(this.sliderPosts) ? void 0 : t(j.Q, {
                                attrs: {
                                    settings: {
                                        itemsToShow: 1
                                    },
                ...
                y = o.componentFactory.create({
                    ...
                    computed: {
                        ...
                        isEnabledReadingTime: function() {
                            return (this.settings.showReadTime || (this.settings.differentFirstImage || this.settings.bgImage) && 0 == this.index) && this.isEnabledElement(w.m.ReadingTime) && !!this.post.expectedReadMinutes
                        }
                    },
                    methods: {
                    ...
                    render: function(t) {
                        ...
                        return t("div", {
                            ...
                            attrs: {
                                value: new f.p({
                                    lczText: new f.L({
                                        lczValue: (null === (r = this.post.button) || void 0 === r || null === (o = r.lczText) || void 0 === o ? void 0 : o.lczValue) || "read more"
                                    }),
                                    page: new f.r({
                                        id: this.post.id,
