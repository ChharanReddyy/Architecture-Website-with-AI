    ...
    [18], {
        535: function(t, e, r) {
            ...
            var n = r(16),
                ...
                C = r(146),
                w = function() {
                    return Promise.all([r.e(3), r.e(17)]).then(r.bind(null, 608))
                },
                v = function t() {
                    Object(o.a)(this, t), this.isLoading = !1
                },
                k = c.componentFactory.create({
                    props: {
                    ...
                    methods: {
                            ...
                            return Object(n.a)(regeneratorRuntime.mark((function e() {
                                ...
                                return regeneratorRuntime.wrap((function(e) {
                                    for (;;) switch (e.prev = e.next) {
                                        case 0:
                                            if (e.prev = 0, t.isLoading = !0, t.isEnabledStoreApp) {
                                                e.next = 4;
                                                break
                                            }
                                            return e.abrupt("return");
                                        case 4:
                                            if (!Object(h.O)(null === (r = t.site) || void 0 === r ? void 0 : r.storeAppSettings)) {
                                                e.next = 9;
                                                break
                                            }
                        ...
                        renderCartItemsList: function(t) {
                            ...
                            return this.isLoading ? t("div", {
                            ...
                            }, [this.$t("messages.noProductsInCart")])]) : t("div", {
                                ...
                                on: {
                                    delete: (e = Object(n.a)(regeneratorRuntime.mark((function t() {
                                        return regeneratorRuntime.wrap((function(t) {
                                            for (;;) switch (t.prev = t.next) {
                                                case 0:
                                                    return t.next = 2, r.onShowCart();
                                                case 2:
                                                case "end":
                                                    return t.stop()
                                            }
